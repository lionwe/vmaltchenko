...
class CtaForm {
  constructor() {
    // Form is inside .cta__form-wrapper
    this.form = document.querySelector('.cta__form-wrapper form');
    
    if (!this.form) return;
    
    this.submitBtn = this.form.querySelector('.cta-form__button'); // Updated class
  ...
  initValidation() {
    ...
    const inputs = this.form.querySelectorAll('.cta-form__input');
   ...
   */
  validateForm() {
    const inputs = this.form.querySelectorAll('.cta-form__input[required]');
    let isValid = true;
